...
var bootstrap = (function () {
  ...
  return load("".concat(customResourceURL, "?id=").concat(config.id, "&l=").concat(globalDataLayerName, "&gtm_auth=").concat(config.params.gtm_auth, "&gtm_preview=").concat(config.params.gtm_preview, "&gtm_cookies_win=x"), {
...
export { addRoutesTracker, bootstrap, config, customMap, install as default, event, exception, install, linker, optIn, optOut, pageview, purchase, query, refund, screenview, set, setOptions, setRouter, time };
